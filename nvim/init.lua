...
local function append_location_to_work_file()
  ...
  vim.api.nvim_buf_set_lines(bufnr, -1, -1, false, { location })
  vim.notify("saved current location: " .. location)
end
...
vim.keymap.set("n", "<leader>t", "<NOP>", { remap = true }) -- next key
vim.keymap.set("n", "<leader>y", "<NOP>", { remap = true }) -- free
vim.keymap.set("n", "<leader>u", "<NOP>", { remap = true }) -- free
vim.keymap.set("n", "<leader>i", function() vim.fn.PutInspectStatementForCurrentWordIntoClipboard() end)
vim.keymap.set("n", "<leader>o", "<NOP>", { remap = true }) -- free
vim.keymap.set("n", "<leader>p", "<NOP>", { remap = true }) -- free
vim.keymap.set("n", "<leader>a", "<C-^>")
vim.keymap.set("n", "<leader>s", "<NOP>", { remap = true }) -- next key
vim.keymap.set("n", "<leader>d", function() vim.fn.GoToDefinition() end)
vim.keymap.set("n", "<leader>f", "<NOP>", { remap = true }) -- free
vim.keymap.set("n", "<leader>g", "<NOP>", { remap = true }) -- next key
vim.keymap.set("n", "<leader>h", "<NOP>", { remap = true }) -- free
vim.keymap.set("n", "<leader>j", "<NOP>") -- free
vim.keymap.set("n", "<leader>k", "<NOP>") -- free
vim.keymap.set("n", "<leader>l", 'oputs "----- DEBUGGERER -- #{ self.class } -- #{ __method__ } 1"<ESC>h', { remap = true })
vim.keymap.set("n", "<leader>z", ":qa<CR>")
vim.keymap.set("n", "<leader>x", "<NOP>", { remap = true }) -- next key
vim.keymap.set("n", "<leader>c", "<NOP>", { remap = true }) -- next key
vim.keymap.set("n", "<leader>v", "<NOP>")                   -- next key
vim.keymap.set("n", "<leader>b", "<NOP>") -- free
vim.keymap.set("n", "<leader>n", "<NOP>", { remap = true }) -- next key
vim.keymap.set("n", "<leader>m", "<NOP>", { remap = true }) -- next key
